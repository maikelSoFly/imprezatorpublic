...
class PaymentDetailsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TicketsDetailsCell", for: indexPath) as! PaymentDetailsTableViewCell
        ...
        let keys = Array(paymentDetails.keys)
        let key = keys[indexPath.section]
        
        cell.configure(price: key, quantity: paymentDetails[key]!)
